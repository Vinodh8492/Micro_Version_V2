...
class BidictBase(BidirectionalMapping[KT, VT]):
    ...
    _fwdm_cls: t.ClassVar[
        type[t.MutableMapping[t.Any, t.Any]]
    ] = dict  #: class of the backing forward mapping
    _invm_cls: t.ClassVar[
        type[t.MutableMapping[t.Any, t.Any]]
    ...
    def _ensure_inv_cls(cls) -> None:
        ...
        if getattr(cls, "__dict__", {}).get(
            "_inv_cls"
        ):  # Don't assume cls.__dict__ (e.g. mypyc native class)
            return
        ...
        *oldkey* and *oldval* are as returned by :meth:`_dedup`.
        ...
        if oldval is MISSING and oldkey is MISSING:  # no key or value duplication
            ...
            if unwrites is not None:
                unwrites.extend(((fwdm_del, newkey), (invm_del, newval),))
        elif (
