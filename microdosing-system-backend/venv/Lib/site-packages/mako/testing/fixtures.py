...
class TemplateTest:
    def _file_template(self, filename, **kw):
        ...
        return Template(
            uri=filename, filename=filepath, module_directory=config.module_base, **kw,
        )
    ...
    def _do_file_test(
        self, filename, expected, filters=None, unicode_=True, template_args=None, **kw,
    ):
    ...
    def _do_memory_test(
        self, source, expected, filters=None, unicode_=True, template_args=None, **kw,
    ):
    ...
    def _do_test(
        self, template, expected, filters=None, template_args=None, unicode_=True,
    ):
