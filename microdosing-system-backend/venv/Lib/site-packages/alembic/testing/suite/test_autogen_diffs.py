...
class AlterColumnTest(AutogenFixtureTest, TestBase):
    ...
    def test_all_existings_filled_in_notnull(self, pk):
        ...
        Table(
            "a", m2, Column("x", Integer, nullable=False, comment="x", primary_key=pk),
        )
...
class AutoincrementTest(AutogenFixtureTest, TestBase):
    ...
    def test_alter_column_autoincrement_pk_false(self):
        ...
        Table(
            "a", m1, Column("x", Integer, primary_key=True, autoincrement=False),
        )
        Table(
            "a", m2, Column("x", BigInteger, primary_key=True, autoincrement=False),
        )
    ...
    def test_alter_column_autoincrement_pk_explicit_true(self):
        ...
        Table(
            "a", m2, Column("x", BigInteger, primary_key=True, autoincrement=True),
        )
    ...
    def test_alter_column_autoincrement_nonpk_implicit_false(self):
        ...
        Table(
            "a", m1, Column("id", Integer, primary_key=True), Column("x", Integer),
        )
        Table(
            "a", m2, Column("id", Integer, primary_key=True), Column("x", BigInteger),
        )
