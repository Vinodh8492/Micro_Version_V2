...
class AutogenerateIdentityTest(AutogenFixtureTest, TestBase):
    ...
    def test_add_identity_column(self):
        ...
        Table(
            ...
            Column("id", Integer, sa.Identity(start=5, increment=7), primary_key=True,),
        )
    ...
    def test_remove_identity_column(self):
        ...
        Table(
            "user",
            m1,
            Column("id", Integer, sa.Identity(start=2, increment=3), primary_key=True,),
        )
    ...
    def test_change_identity(self, before, after):
        ...
        Table(
            "user", m1, Column("id", Integer, *arg_before), Column("other", sa.Text),
        )

        Table(
            "user", m2, Column("id", Integer, *arg_after), Column("other", sa.Text),
        )
    ...
    def test_add_identity_to_column(self):
        ...
        Table(
            "user", m1, Column("id", Integer), Column("other", sa.Text),
        )
    ...
    def test_remove_identity_from_column(self):
        ...
        Table(
            "user", m2, Column("id", Integer), Column("other", sa.Text),
        )
