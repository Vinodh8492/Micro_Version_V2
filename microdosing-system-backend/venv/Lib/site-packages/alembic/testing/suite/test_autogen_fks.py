...
class AutogenerateForeignKeysTest(AutogenFixtureTest, TestBase):
    ...
    def test_remove_fk(self):
        ...
        Table(
            "some_table", m1, Column("test", String(10), primary_key=True),
        )
        ...
        Table(
            "some_table", m2, Column("test", String(10), primary_key=True),
        )
    ...
    def test_no_change_composite_fk(self):
        ...
        Table(
            ...
            ForeignKeyConstraint(
                ["other_id_1", "other_id_2"], ["some_table.id_1", "some_table.id_2"],
            ),
        )
    ...
    def test_casing_convention_changed_so_put_drops_first(self):
        ...
        self._assert_fk_diff(
            diffs[1], "add_fk", "user", ["a1"], "some_table", ["test"], name="myfk",
        )
...
class IncludeHooksTest(AutogenFixtureTest, TestBase):
    ...
    def test_remove_connection_fk(self, hook_type):
        ...
        self._assert_fk_diff(
            diffs[0], "remove_fk", "t", ["y"], "ref", ["id"], conditional_name="fk2",
        )
        eq_(len(diffs), 1)
    ...
    def test_change_fk(self, hook_type):
        ...
        t1 = Table(
            "t", m1, Column("x", Integer), Column("y", Integer), Column("z", Integer),
        )
        ...
        Table(
            "ref_a", m2, Column("a", Integer, primary_key=True),
        )
        r2b = Table(
            "ref_b",
            m2,
        ...
        t2 = Table(
            "t", m2, Column("x", Integer), Column("y", Integer), Column("z", Integer),
        )
        ...
        if hook_type == "object":
            ...
            self._assert_fk_diff(
                diffs[1], "add_fk", "t", ["y", "z"], "ref_b", ["a", "b"], name="fk2",
            )
            eq_(len(diffs), 2)
        elif hook_type == "name":
            eq_(
...
class AutogenerateFKOptionsTest(AutogenFixtureTest, TestBase):
    ...
    def test_remove_ondelete(self):
        ...
        self._assert_fk_diff(
            diffs[1], "add_fk", "user", ["tid"], "some_table", ["id"], ondelete=None,
        )
    ...
    def test_remove_onupdate(self):
        ...
        self._assert_fk_diff(
            diffs[1], "add_fk", "user", ["tid"], "some_table", ["id"], onupdate=None,
        )
    ...
    def test_remove_initially_deferred(self):
        ...
        self._assert_fk_diff(
            diffs[1], "add_fk", "user", ["tid"], "some_table", ["id"], initially=None,
        )
    ...
    def test_add_deferrable(self):
        ...
        self._assert_fk_diff(
            diffs[1], "add_fk", "user", ["tid"], "some_table", ["id"], deferrable=True,
        )
    ...
    def test_remove_deferrable(self):
        ...
        self._assert_fk_diff(
            diffs[1], "add_fk", "user", ["tid"], "some_table", ["id"], deferrable=None,
        )
