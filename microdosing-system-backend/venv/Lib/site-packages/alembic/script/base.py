...
class ScriptDirectory:
    ...
    def get_revisions(self, id_: _GetRevArg) -> Tuple[Script, ...]:
        ...
        with self._catch_revision_errors():
            return cast(Tuple[Script, ...], self.revision_map.get_revisions(id_),)
    ...
    def iterate_revisions(
        ...
        **kw: Any,
        ...
        """
        return cast(
            Iterator[Script], self.revision_map.iterate_revisions(upper, lower, **kw),
        )
    ...
    def generate_revision(
        ...
        **kw: Any,
        ...
        with self._catch_revision_errors(
            ...
            heads = cast(
                Tuple[Optional["Revision"], ...], self.revision_map.get_revisions(head),
            )
            for h in heads:
