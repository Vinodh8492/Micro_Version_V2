...
class AbstractOperations(util.ModuleClsProxy):
    ...
    def register_operation(
        ...
        def register(op_cls: Type[_T]) -> Type[_T]:
            ...
            args = re.sub(
                r'[_]?ForwardRef\(([\'"].+?[\'"])\)', lambda m: m.group(1), args,
            )
    ...
    def run_async(
        self, async_function: Callable[..., Awaitable[_T]], *args: Any, **kw_args: Any,
    ) -> _T:
...
class Operations(AbstractOperations):
    ...
    if TYPE_CHECKING:
        ...
        def add_column(
            self, table_name: str, column: Column[Any], *, schema: Optional[str] = None,
        ) -> None:
        ...
        def create_exclude_constraint(
            self, constraint_name: str, table_name: str, *elements: Any, **kw: Any,
        ) -> Optional[Table]:
...
class BatchOperations(AbstractOperations):
    ...
    if TYPE_CHECKING:
        ...
        def create_table_comment(
            self, comment: Optional[str], *, existing_comment: Optional[str] = None,
        ) -> None:
            """Emit a COMMENT ON operation to set the comment for a table
