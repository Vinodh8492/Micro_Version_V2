...
class DropIndexOp(MigrateOperation):
    ...
    def drop_index(
        ...
        **kw: Any,
        ...
        """
        op = cls(
            index_name, table_name=table_name, schema=schema, if_exists=if_exists, **kw,
        )
        return operations.invoke(op)
    ...
    def reverse(self) -> Union[CreateTableCommentOp, DropTableCommentOp]:
        ...
        if self.existing_comment is None:
            return DropTableCommentOp(
                self.table_name, existing_comment=self.comment, schema=self.schema,
            )
        else:
...
class DropTableCommentOp(AlterTableOp):
    ...
    def batch_drop_table_comment(
        cls, operations: BatchOperations, *, existing_comment: Optional[str] = None,
    ) -> None:
        """Issue a "drop table comment" operation to
...
class AddColumnOp(AlterTableOp):
    ...
    def from_column_and_tablename(
        cls, schema: Optional[str], tname: str, col: Column[Any],
    ) -> AddColumnOp:
    ...
    def batch_add_column(
        ...
        *,
        ...
        op = cls(
            operations.impl.table_name, column, schema=operations.impl.schema, **kw,
        )
        return operations.invoke(op)
...
class UpgradeOps(OpContainer):
    ...
    def __init__(
        self, ops: Sequence[MigrateOperation] = (), upgrade_token: str = "upgrades",
    ) -> None:
...
class DowngradeOps(OpContainer):
    ...
    def __init__(
        self, ops: Sequence[MigrateOperation] = (), downgrade_token: str = "downgrades",
    ) -> None:
        super().__init__(ops=ops)
