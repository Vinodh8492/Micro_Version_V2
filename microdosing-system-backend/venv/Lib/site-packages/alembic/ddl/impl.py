...
class ImplMeta(type):
    def __init__(
        cls, classname: str, bases: Tuple[Type[DefaultImpl]], dict_: Dict[str, Any],
    ):
...
class DefaultImpl(metaclass=ImplMeta):
    ...
    def drop_column(
        self, table_name: str, column: Column[Any], schema: Optional[str] = None, **kw,
    ) -> None:
    ...
    def _compare_identity_default(self, metadata_identity, inspector_identity):
        ...
        diff, ignored = _compare_identity_options(
            metadata_identity, inspector_identity, schema.Identity(), skip={"always"},
        )
