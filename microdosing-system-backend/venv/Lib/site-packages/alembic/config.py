...
class CommandLine:
    ...
    def _generate_args(self, prog: Optional[str]) -> None:
            ...
            for arg in positional:
                if (
                    ...
                    subparser.add_argument(
                        "revisions", nargs="+", help=positional_help.get("revisions"),
                    )
                else:
        ...
        parser.add_argument(
            "-q", "--quiet", action="store_true", help="Do not log to std output.",
        )
...
def main(
    argv: Optional[Sequence[str]] = None, prog: Optional[str] = None, **kwargs: Any,
) -> None:
