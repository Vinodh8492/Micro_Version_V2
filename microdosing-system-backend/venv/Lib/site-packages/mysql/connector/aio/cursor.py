...
class MySQLCursor(MySQLCursorAbstract):
    ...
    async def _prepare_statement(
        self, operation: StrOrBytes, params: Union[Sequence[Any], Dict[str, Any]] = (),
    ) -> bytes:
    ...
    async def callproc(
        self, procname: str, args: Sequence[Any] = (),
        ...
        try:
            ...
            async for result in self._connection.cmd_query_iter(
                ...
                if isinstance(self, (MySQLCursorDict, MySQLCursorBufferedDict)):
                    ...
                    self, (MySQLCursorNamedTuple, MySQLCursorBufferedNamedTuple),
                ):
