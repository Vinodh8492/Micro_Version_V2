...
class SimData:
    ...
    **Examples**:
    ...
    def __check_datatype(self):
        ...
        if self.datatype == SimDataType.BITS and not isinstance(
            self.value, (bool, int)
        ):
    ...
    def __post_init__(self):
        ...
        if self.action and not (
            callable(self.action) or asyncio.iscoroutinefunction(self.action)
        ):
    ...
    **Device with non-shared registers**::
    ...
    def __post_init__(self):
        ...
        if self.block_shared:
            if (
                self.block_coil
                or self.block_direct
                or self.block_holding
                or self.block_input
            ):
