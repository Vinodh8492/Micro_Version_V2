...
class DiagnosticBase(ModbusPDU):
    ...
    def __init__(
        self,
        message: bytes | int | list | tuple | None = 0,
        dev_id: int = 1,
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return response(
            message=self.message, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnDiagnosticRegisterRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnDiagnosticRegisterResponse(
            message=register, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ChangeAsciiInputDelimiterRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        _MCB.Delimiter = char
        return ChangeAsciiInputDelimiterResponse(
            message=self.message, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnBusMessageCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnBusMessageCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnBusCommunicationErrorCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnBusCommunicationErrorCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnBusExceptionErrorCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnBusExceptionErrorCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnSlaveMessageCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnSlaveMessageCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnSlaveNoResponseCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnSlaveNoResponseCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnSlaveNAKCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnSlaveNAKCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnSlaveBusyCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnSlaveBusyCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnSlaveBusCharacterOverrunCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ReturnSlaveBusCharacterOverrunCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ReturnIopOverrunCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        """update_datastore the diagnostic request on the given device."""
        count = _MCB.Counter.BusCharacterOverrun
        return ReturnIopOverrunCountResponse(
            message=count, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class ClearOverrunCountRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return ClearOverrunCountResponse(
            dev_id=self.dev_id, transaction_id=self.transaction_id
        )
...
class GetClearModbusPlusRequest(DiagnosticBase):
    ...
    async def update_datastore(self, _context: ModbusSlaveContext) -> ModbusPDU:
        ...
        return GetClearModbusPlusResponse(
            message=message, dev_id=self.dev_id, transaction_id=self.transaction_id
        )
