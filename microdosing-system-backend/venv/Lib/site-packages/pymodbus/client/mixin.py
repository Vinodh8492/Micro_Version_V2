...
class ModbusClientMixin(Generic[T]):  # pylint: disable=too-many-public-methods
    ...
    def read_coils(
        ...
        *,
        ...
        return self.execute(
            ...
            pdu_bit.ReadCoilsRequest(address=address, count=count, dev_id=slave),
        )
    ...
    def read_holding_registers(
        ...
        *,
        ...
        return self.execute(
            no_response_expected,
            pdu_reg.ReadHoldingRegistersRequest(
                address=address, count=count, dev_id=slave
            ),
        )
    ...
    def read_input_registers(
        ...
        *,
        ...
        return self.execute(
            no_response_expected,
            pdu_reg.ReadInputRegistersRequest(
                address=address, count=count, dev_id=slave
            ),
        )
    ...
    def write_coil(
        ...
        *,
        ...
        pdu = pdu_bit.WriteSingleCoilRequest(
            address=address, bits=[value], dev_id=slave
        )
        return self.execute(no_response_expected, pdu)
        ...
        *,
        ...
        return self.execute(
            ...
            pdu_reg.WriteSingleRegisterRequest(
                address=address, registers=[value], dev_id=slave
            ),
        )

    def read_exception_status(
        self, *, slave: int = 1, no_response_expected: bool = False
    ) -> T:
        ...
        """
        return self.execute(
            no_response_expected, pdu_other_msg.ReadExceptionStatusRequest(dev_id=slave)
        )

    def diag_query_data(
        self, msg: bytes, *, slave: int = 1, no_response_expected: bool = False
    ) -> T:
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ReturnQueryDataRequest(msg, dev_id=slave)
        )

    def diag_restart_communication(
        self, toggle: bool, *, slave: int = 1, no_response_expected: bool = False
    ) -> T:
        ...
        return self.execute(
            no_response_expected,
            pdu_diag.RestartCommunicationsOptionRequest(message=msg, dev_id=slave),
        )
    ...
    def diag_read_diagnostic_register(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ReturnDiagnosticRegisterRequest(dev_id=slave)
        )
    ...
    def diag_change_ascii_input_delimeter(
        ...
        *,
        ...
        return self.execute(
            no_response_expected,
            pdu_diag.ChangeAsciiInputDelimiterRequest(message=delimiter, dev_id=slave),
        )
    ...
    def diag_force_listen_only(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ForceListenOnlyModeRequest(dev_id=slave)
        )
    ...
    def diag_clear_counters(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ClearCountersRequest(dev_id=slave)
        )
    ...
    def diag_read_bus_message_count(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ReturnBusMessageCountRequest(dev_id=slave)
        )
    ...
    def diag_read_bus_comm_error_count(
        ...
        return self.execute(
            no_response_expected,
            pdu_diag.ReturnBusCommunicationErrorCountRequest(dev_id=slave),
        )
    ...
    def diag_read_bus_exception_error_count(
        ...
        return self.execute(
            no_response_expected,
            pdu_diag.ReturnBusExceptionErrorCountRequest(dev_id=slave),
        )
    ...
    def diag_read_slave_message_count(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ReturnSlaveMessageCountRequest(dev_id=slave)
        )
    ...
    def diag_read_slave_no_response_count(
        ...
        return self.execute(
            no_response_expected,
            pdu_diag.ReturnSlaveNoResponseCountRequest(dev_id=slave),
        )
    ...
    def diag_read_slave_nak_count(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ReturnSlaveNAKCountRequest(dev_id=slave)
        )
    ...
    def diag_read_slave_busy_count(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ReturnSlaveBusyCountRequest(dev_id=slave)
        )
    ...
    def diag_read_bus_char_overrun_count(
        ...
        return self.execute(
            no_response_expected,
            pdu_diag.ReturnSlaveBusCharacterOverrunCountRequest(dev_id=slave),
        )
    ...
    def diag_read_iop_overrun_count(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ReturnIopOverrunCountRequest(dev_id=slave)
        )
    ...
    def diag_clear_overrun_counter(
        ...
        """
        return self.execute(
            no_response_expected, pdu_diag.ClearOverrunCountRequest(dev_id=slave)
        )

    def diag_getclear_modbus_response(
        self, *, data: int = 0, slave: int = 1, no_response_expected: bool = False
    ) -> T:
        ...
        return self.execute(
            no_response_expected,
            pdu_diag.GetClearModbusPlusRequest(message=data, dev_id=slave),
        )
    ...
    def diag_get_comm_event_counter(
        ...
        """
        return self.execute(
            no_response_expected, pdu_other_msg.GetCommEventCounterRequest(dev_id=slave)
        )
    ...
    def diag_get_comm_event_log(
        ...
        """
        return self.execute(
            no_response_expected, pdu_other_msg.GetCommEventLogRequest(dev_id=slave)
        )
    ...
    def report_slave_id(
        ...
        """
        return self.execute(
            no_response_expected, pdu_other_msg.ReportSlaveIdRequest(dev_id=slave)
        )

    def read_file_record(
        self,
        records: list[pdu_file_msg.FileRecord],
        *,
        slave: int = 1,
        no_response_expected: bool = False,
    ) -> T:
        ...
        return self.execute(
            no_response_expected,
            pdu_file_msg.ReadFileRecordRequest(records, dev_id=slave),
        )
    ...
    def write_file_record(
        ...
        *,
        ...
        return self.execute(
            no_response_expected,
            pdu_file_msg.WriteFileRecordRequest(records=records, dev_id=slave),
        )
        ...
        *,
        ...
        return self.execute(
            ...
            pdu_reg.MaskWriteRegisterRequest(
                address=address, and_mask=and_mask, or_mask=or_mask, dev_id=slave
            ),
        )
    ...
    def read_fifo_queue(
        ...
        *,
        ...
        return self.execute(
            no_response_expected,
            pdu_file_msg.ReadFifoQueueRequest(address, dev_id=slave),
        )
    ...
    def read_device_information(
        ...
        *,
        ...
        return self.execute(
            no_response_expected,
            pdu_mei.ReadDeviceInformationRequest(read_code, object_id, dev_id=slave),
        )
    ...
    def convert_from_registers(
        ...
        if not (data_len := data_type.value[1]):
            ...
            if data_type == cls.DATATYPE.STRING:
                ...
                while (
                    trailing_nulls_begin > 0 and not byte_list[trailing_nulls_begin - 1]
                ):
